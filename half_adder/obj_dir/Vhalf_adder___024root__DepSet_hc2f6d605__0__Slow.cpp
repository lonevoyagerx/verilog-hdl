...
VL_ATTR_COLD void Vhalf_adder___024root___eval_initial(Vhalf_adder___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vhalf_adder__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
...
#ifdef VL_DEBUG
VL_ATTR_COLD void Vhalf_adder___024root___dump_triggers__stl(Vhalf_adder___024root* vlSelf);
#endif  // VL_DEBUG
VL_ATTR_COLD bool Vhalf_adder___024root___eval_phase__stl(Vhalf_adder___024root* vlSelf);
...
#ifdef VL_DEBUG
            Vhalf_adder___024root___dump_triggers__stl(vlSelf);
#endif
            VL_FATAL_MT("half_adder.v", 1, "", "Settle region did not converge.");
        }
        __VstlIterCount = ((IData)(1U) + __VstlIterCount);
        __VstlContinue = 0U;
        if (Vhalf_adder___024root___eval_phase__stl(vlSelf)) {
            __VstlContinue = 1U;
        }
...
VL_ATTR_COLD void Vhalf_adder___024root___dump_triggers__stl(Vhalf_adder___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vhalf_adder__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vhalf_adder___024root___dump_triggers__stl\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vhalf_adder___024root___eval_stl(Vhalf_adder___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vhalf_adder__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vhalf_adder___024root___eval_stl\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    if ((1ULL & vlSelfRef.__VstlTriggered.word(0U))) {
...
VL_ATTR_COLD void Vhalf_adder___024root___eval_triggers__stl(Vhalf_adder___024root* vlSelf);

VL_ATTR_COLD bool Vhalf_adder___024root___eval_phase__stl(Vhalf_adder___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vhalf_adder__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vhalf_adder___024root___eval_phase__stl\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    CData/*0:0*/ __VstlExecute;
    // Body
    Vhalf_adder___024root___eval_triggers__stl(vlSelf);
    __VstlExecute = vlSelfRef.__VstlTriggered.any();
    if (__VstlExecute) {
        Vhalf_adder___024root___eval_stl(vlSelf);
    }
...
VL_ATTR_COLD void Vhalf_adder___024root___dump_triggers__ico(Vhalf_adder___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vhalf_adder__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vhalf_adder___024root___dump_triggers__ico\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
