...
class alignas(VL_CACHE_LINE_BYTES)Vfull_adder_tb__Syms final : public VerilatedSyms {
  public:
    // INTERNAL STATE
    ...
    Vfull_adder_tb___024unit       TOP____024unit;

    // SCOPE NAMES
    VerilatedScope __Vscope_full_adder_tb;
